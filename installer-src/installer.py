...
# Any line in index.js that mentions this string = injected by Claisum
MARKER = "claisum_inject"

# Two lines written to the top of Discord's index.js
INJECT = (
...
def do_remove_str(content):
    """Strip every line that mentions claisum_inject or the [Claisum] comment."""
    lines = content.splitlines(keepends=True)
    cleaned = [l for l in lines
               if MARKER not in l and "[Claisum]" not in l]
...
def do_inject(idx):
    with open(idx, "r", encoding="utf-8") as f:
        raw = f.read()
    # Always clean first so repair works too
...
class App(tk.Tk):
    ...
    def _build_chrome(self):
        ...
        # Footer packed BEFORE content so it never disappears
    ...
    def _do_install(self):
        ...
        self.after(400, lambda: self._finish(True,
            ...
            "bottom-left corner of Discord. Click it to open settings.\n\n"
    ...
    def _do_uninstall(self):
        ...
        self.after(400, lambda: self._finish(True,
            ...
            "You can verify by opening Discord normally."))
